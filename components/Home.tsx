    ...
    <main className="relative bg-[#0b0f0c]">
      ...
      <section className="mx-auto max-w-5xl px-6 py-24 text-center">
        <h2 className="mb-8 text-lg font-medium text-neutral-400 md:text-2xl">
          Companies we{" "}
          <span className="font-semibold text-purple-400">Collaborate</span> with
        </h2>
        <LogoCloud />
      </section>
      ...
      >
        <h2 className="text-3xl font-semibold text-white">About GyraLabs</h2>
        <p className="mt-6 text-neutral-400">
          GyraLabs builds agentic AI systems designed for autonomy, memory, and
